...
public class CurrentStockData implements CurrentStockDataService {
     ...
     */
    @Override
    public CurrentStockPO getCurrentStockPO_US(String id) throws Exception {
        return new CurrentStockPO(getCurrentData_US(id), "us");
    }
     ...
     * @throws Exception
     */
    private String getCurrentData_US(String id) throws Exception {
        String result;
...
//        System.out.println(new CurrentStockData().getCurrentData("sh601009"));
        System.out.println(new CurrentStockData().getCurrentData_US("aapl"));
    }
}
