...
public class MarketIndexDetailPanel extends JPanel {
    ...
    public MarketIndexDetailPanel(String chooseDateInit[]) throws IOException {
    ...
    private void init() throws IOException {
       indexKLine_Daily = new IndexKLine_Daily().getChartPanel();
        ...
        ImageIcon image8 = new ImageIcon("client/src/main/resources/images/weekK.png");
        ImageIcon image9 = new ImageIcon("client/src/main/resources/images/monthK.png");
        ...
        tabbedPane.addTab(null,image7,indexKLine_Daily,"日k线");
        tabbedPane.addTab(null,image8,indexKLine_Weekly,"周k线");
        tabbedPane.addTab(null,image9,indexKLine_Monthly,"月k线");
