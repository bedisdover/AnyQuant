 ...
 * 
 * Example - create a new filter that filberts out all files but gif and jpg
 * image files:
 * 
...
public class ExampleFileFilter extends FileFilter {
	 ...
	 * Example: new ExampleFileFilter("jpg");addExtension
	 */
	 ...
	 * 
	 * Note that the "." before the extension is not needed adn will be ignored.addExtension
	 */
	 ...
	 * it shouldn't.
	 * 
	 * Files that begin with "." are ignored.getExtensi#
	 */
	...
	/**
	 * Return the extension portion of the file's name .getExtensi#accept
	 */
	 ...
	 * "JPEG and GIF Image Files (*.jpg, *.gif)"#getDescription
	 */
