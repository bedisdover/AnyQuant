...
public class ImageLoader {
     ...
     * ”K线图“图标
     */
    public static Image kLine;

    /**
     * “折线图”图标
     */
    public static Image brokenLine;
    ...
    static {
        try {
            ...
            kLine = ImageIO.read(new File(IMAGE_PATH + "kLine.png"));
            brokenLine = ImageIO.read(new File(IMAGE_PATH + "brokenLine.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
