...
<div class="row">
    ...
    <div class="col-md-9 content">
        ...
        <div class="graphs" id="graphs">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="雷达图">
                    <%--<div class="chart" id="radar-chart-chart"></div>--%>
                </div>
            </div>
        </div>
        <%-- latest-data --%>
        <div class="chart-list">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#weekly_k" aria-controls="weekly_k" role="tab" data-toggle="tab"
                    >周K线</a>
                </li>
                <li role="presentation">
                    <a href="#monthly_k" aria-controls="monthly_k" role="tab" data-toggle="tab"
                    onclick="monthlyKLine()">月K线</a>
                </li>
            </ul>
    ...
    <div id="radar-chart" style="width: 800px; height: 500px;"></div>
